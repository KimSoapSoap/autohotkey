...
FourWayMagicAtTargetBox(key) { 
    ...
    StopLoop := false
        loop,1 {
            ...
            CustomSleep(30)
            SendInput, {Right}
            CustomSleep(20)   ;StopLoopCheck() 다음에 방향키 씹힘방지로 후딜 하나 더 넣음. 그래서 이 앞에 후딜도 30에서 20으로 줄임
...
InputWaiting() {    
    ...
    } else if (ErrorLevel = "EndKey:e") { ; 타겟박스 기준 4방향 활력 -> 활력은 사실 4방향 활력 필요 없긴 하다. 일단 임시
